...
def capturer_dynamic_attributes(center_axis, tag,
...
#    dt = 'mixed'
    '''#### color augmentation ####'''
    rgb_rule_file = 'rules/xview_gaussian/xsbw_xcolor_uniform_for_one_model_bias_rc4/yx_xview_plane_rc4_{}_gauss.cga'.format(dt)
    gt_rule_file = 'rules/xview_gaussian/xsbw_xcolor_uniform_for_one_model_bias_rc4/yx_xview_plane_rc4_{}_labeling_gauss.cga'.format(dt)
    color_pro_list = [10, 20, 30, 40]
    '''########### dynsigma color'''
#    for s in color_pro_list:
#        inx = color_pro_list.index(s)
##        parent_folder = 'syn_xview_bkg_xbw_xbkg_unif_shdw_split_scatter_gauss_rndsolar_ssig0.09_{}_square_bias{}_RC4_v{}'.format(dt, s, inx + 71)
##        parent_folder = 'syn_xview_bkg_xbw_xbkg_unif_shdw_split_scatter_gauss_rndsolar_ssig0.09_{}_square_bias{}_RC4_v{}'.format(dt, s, inx + 90)
##        parent_folder = 'syn_xview_bkg_xbw_xbkg_unif_shdw_split_scatter_gauss_rndsolar_ssig0.03_{}_square_bias{}_RC4_v{}'.format(dt, s, inx + 95)
#        parent_folder = 'syn_xview_bkg_xbw_newbkg_unif_shdw_split_scatter_gauss_rndsolar_ssig0.12_{}_square_bias{}_RC4_v{}'.format(dt, s, inx + 116)
#        print(parent_folder)
...
#    parent_folder = 'syn_xview_bkg_xbw_xbkg_unif_shdw_split_scatter_gauss_rndsolar_ssig0.09_{}_square_bias{}_RC4_v{}'.format(dt, color_pro, inx + 71)
#    parent_folder = 'syn_xview_bkg_xbw_xbkg_unif_shdw_split_scatter_gauss_rndsolar_ssig0.09_{}_square_bias{}_RC4_v{}'.format(dt, color_pro, inx + 90)
#    parent_folder = 'syn_xview_bkg_xbw_xbkg_unif_shdw_split_scatter_gauss_rndsolar_ssig0.03_{}_square_bias{}_RC4_v{}'.format(dt, color_pro, inx + 95)
    parent_folder = 'syn_xview_bkg_xbw_newbkg_unif_shdw_split_scatter_gauss_rndsolar_ssig0.12_{}_square_bias{}_RC4_v{}'.format(dt, color_pro, inx + 116)
 
    '''#### size augmentation  ####'''
#    rgb_rule_file = 'rules/xview_gaussian/xsbw_xcolor_uniform_for_one_model_bias_rc4/size_aug/yx_xview_plane_rc4_box_muller.cga' #, 'rules/xview/xsbw_xcolor_uniform_for_one_model_bias_rc1/yx_xview_plane_mixed.cga'
#    gt_rule_file = 'rules/xview_gaussian/xsbw_xcolor_uniform_for_one_model_bias_rc4/size_aug/yx_xview_plane_rc4_labeling_box_muller.cga' #, 'rules/xview/xsbw_xcolor_uniform_for_one_model_bias_rc1/yx_xview_plane_labeling_mixed.cga'
#    '''########### dynsigma size'''
#    size_pro_list = [0, 0.03, 0.06, 0.09, 0.12]
##    for s in size_pro_list:
##        inx = size_pro_list.index(s)
###        parent_folder = 'syn_xview_bkg_xbw_xbkg_unif_shdw_split_scatter_gauss_rndsolar_promu_size_bias{}_RC4_v{}'.format(s, inx + 40)
###        parent_folder = 'syn_xview_bkg_xbw_xbkg_unif_shdw_split_scatter_gauss_rndsolar_promu_size_square_bias{}_RC4_v{}'.format(s, inx + 100)
##        parent_folder = 'syn_xview_bkg_xbw_newbkg_unif_shdw_split_scatter_gauss_rndsolar_promu_size_square_bias{}_RC4_v{}'.format(s, inx + 110)
##        print(parent_folder)
##        if not os.path.exists(ce.toFSPath('images/{}'.format(parent_folder))):
##            os.makedirs(ce.toFSPath('images/{}'.format(parent_folder)))
#    
...
##    parent_folder = 'syn_xview_bkg_xbw_xbkg_unif_shdw_split_scatter_gauss_rndsolar_promu_size_bias{}_RC4_v{}'.format(size_pro, inx + 40)
##    parent_folder = 'syn_xview_bkg_xbw_xbkg_unif_shdw_split_scatter_gauss_rndsolar_promu_size_square_bias{}_RC4_v{}'.format(size_pro, inx + 100)
#    parent_folder = 'syn_xview_bkg_xbw_newbkg_unif_shdw_split_scatter_gauss_rndsolar_promu_size_square_bias{}_RC4_v{}'.format(size_pro, inx + 110)
    ...
    for sd in rnd_points:
        ...
        capturer_dynamic_attributes(center_axis,
    ...
    for sd in rnd_points:
        ...
        capturer_dynamic_attributes(center_axis=center_axis, 
                                     tag=tag, mode=mode, folder_name=folder_name,
                                     solar_elevation_angle=solar_ele_angle, 
                                     solar_azimuth_angle=solar_azi_angle,
                                     camera_angle=camera_angle,
