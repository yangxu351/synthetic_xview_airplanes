...
if __name__ == '__main__':
    ...
    '''
    '''#### color augmentation ####'''
    rgb_rule_file = 'rules/xview_gaussian/xsbw_xcolor_uniform_for_one_model_bias_rc1/yx_xview_plane_rc1_color_gauss.cga' 
    gt_rule_file = 'rules/xview_gaussian/xsbw_xcolor_uniform_for_one_model_bias_rc1/yx_xview_plane_rc1_color_labeling_gauss.cga'
    '''# ######  '''
    ######### dynamic color sigma
    color_pro = 10
...
##        parent_folder = 'syn_xview_bkg_xbw_xbkg_unif_mig21_shdw_split_scatter_gauss_rndsolar_ssig0_color_square_bias{}_RC1_v{}'.format(s, inx + 90)
##        parent_folder = 'syn_xview_bkg_xbw_xbkg_unif_mig21_shdw_split_scatter_gauss_rndsolar_ssig0.06_color_square_bias{}_RC1_v{}'.format(s, inx + 96)
#        parent_folder = 'syn_xview_bkg_xbw_newbkg_unif_mig21_shdw_split_scatter_gauss_rndsolar_ssig0.03_color_square_bias{}_RC1_v{}'.format(s, inx + 116)
#        print(parent_folder)
...
#    parent_folder = 'syn_xview_bkg_xbw_xbkg_unif_mig21_shdw_split_scatter_gauss_rndsolar_ssig0_color_square_bias{}_RC1_v{}'.format(color_pro, inx + 90)
#    parent_folder = 'syn_xview_bkg_xbw_xbkg_unif_mig21_shdw_split_scatter_gauss_rndsolar_ssig0.06_color_square_bias{}_RC1_v{}'.format(color_pro, inx + 96)
    parent_folder = 'syn_xview_bkg_xbw_newbkg_unif_mig21_shdw_split_scatter_gauss_rndsolar_ssig0.03_color_square_bias{}_RC1_v{}'.format(color_pro, inx + 116)
        
    
    '''#### size augmentation  ####'''
#    rgb_rule_file = 'rules/xview_gaussian/xsbw_xcolor_uniform_for_one_model_bias_rc1/size_aug/yx_xview_plane_rc1_box_muller.cga' #, 'rules/xview/xsbw_xcolor_uniform_for_one_model_bias_rc1/yx_xview_plane_mixed.cga'
#    gt_rule_file = 'rules/xview_gaussian/xsbw_xcolor_uniform_for_one_model_bias_rc1/size_aug/yx_xview_plane_rc1_labeling_box_muller.cga' #, 'rules/xview/xsbw_xcolor_uniform_for_one_model_bias_rc1/yx_xview_plane_labeling_mixed.cga'
#    '''########### dynsigma size'''
#    size_pro = 0
#    size_pro_list = [0, 0.03, 0.06, 0.09, 0.12]
##    for s in size_pro_list:
##        inx = size_pro_list.index(s)
###        parent_folder = 'syn_xview_bkg_xbw_xbkg_unif_mig21_shdw_split_scatter_gauss_rndsolar_promu_size_square_bias{}_RC1_v{}'.format(s, inx + 100)
##        parent_folder = 'syn_xview_bkg_xbw_newbkg_unif_mig21_shdw_split_scatter_gauss_rndsolar_promu_size_square_bias{}_RC1_v{}'.format(s, inx + 110)
##        print(parent_folder)
##        if not os.path.exists(ce.toFSPath('images/{}'.format(parent_folder))):
##            os.makedirs(ce.toFSPath('images/{}'.format(parent_folder)))
#    inx = size_pro_list.index(size_pro)
##    parent_folder = 'syn_xview_bkg_xbw_xbkg_unif_mig21_shdw_split_scatter_gauss_rndsolar_promu_size_square_bias{}_RC1_v{}'.format(size_pro, inx + 100)
#    parent_folder = 'syn_xview_bkg_xbw_newbkg_unif_mig21_shdw_split_scatter_gauss_rndsolar_promu_size_square_bias{}_RC1_v{}'.format(size_pro, inx + 110)
