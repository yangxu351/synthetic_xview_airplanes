...
if __name__ == '__main__':
    ...
    '''#### color augmentation ####'''
    rgb_rule_file = 'rules/xview_gaussian/xsbw_xcolor_uniform_for_one_model_bias_rc3/yx_xview_plane_rc3_color_gauss.cga' #, 'rules/xview/xsbw_xcolor_uniform_for_one_model_bias_rc1/yx_xview_plane_mixed.cga'
    gt_rule_file = 'rules/xview_gaussian/xsbw_xcolor_uniform_for_one_model_bias_rc3/yx_xview_plane_rc3_color_labeling_gauss.cga' #, 'rules/xview/xsbw_xcolor_uniform_for_one_model_bias_rc1/yx_xview_plane_labeling_mixed.cga'
    '''########### dynsigma'''
    color_pro_list = [10, 20, 30, 40]
#    for s in color_pro_list:
#        inx = color_pro_list.index(s)
##        parent_folder = 'syn_xview_bkg_xbw_xbkg_unif_shdw_split_scatter_gauss_rndsolar_ssig0.09_color_bias{}_RC3_v{}'.format(s, inx + 60)
##        parent_folder = 'syn_xview_bkg_xbw_xbkg_unif_shdw_split_scatter_gauss_rndsolar_ssig0.09_color_square_bias{}_RC3_v{}'.format(s, inx + 91)
#        parent_folder = 'syn_xview_bkg_xbw_newbkg_unif_shdw_split_scatter_gauss_rndsolar_ssig0.03_color_square_bias{}_RC3_v{}'.format(s, inx + 116)
#        print(parent_folder)
...
#    parent_folder = 'syn_xview_bkg_xbw_xbkg_unif_shdw_split_scatter_gauss_rndsolar_ssig0.09_color_bias{}_RC3_v{}'.format(color_pro, inx + 60)
#    parent_folder = 'syn_xview_bkg_xbw_xbkg_unif_shdw_split_scatter_gauss_rndsolar_ssig0.09_color_square_bias{}_RC3_v{}'.format(color_pro, inx + 91)
    parent_folder = 'syn_xview_bkg_xbw_newbkg_unif_shdw_split_scatter_gauss_rndsolar_ssig0.03_color_square_bias{}_RC3_v{}'.format(color_pro, inx + 116)

    '''#### size augmentation  ####'''
#    rgb_rule_file = 'rules/xview_gaussian/xsbw_xcolor_uniform_for_one_model_bias_rc3/size_aug/yx_xview_plane_rc3_box_muller.cga' #, 'rules/xview/xsbw_xcolor_uniform_for_one_model_bias_rc1/yx_xview_plane_mixed.cga'
#    gt_rule_file = 'rules/xview_gaussian/xsbw_xcolor_uniform_for_one_model_bias_rc3/size_aug/yx_xview_plane_rc3_labeling_box_muller.cga' #, 'rules/xview/xsbw_xcolor_uniform_for_one_model_bias_rc1/yx_xview_plane_labeling_mixed.cga'
#    '''########### dynsigma'''
#    size_pro_list = [0, 0.03, 0.06, 0.09, 0.12]
##    for s in size_pro_list:
##        inx = size_pro_list.index(s)
###        parent_folder = 'syn_xview_bkg_xbw_xbkg_unif_shdw_split_scatter_gauss_rndsolar_promu_size_bias{}_RC3_v{}'.format(s, inx + 40)
###        parent_folder = 'syn_xview_bkg_xbw_xbkg_unif_shdw_split_scatter_gauss_rndsolar_promu_size_square_bias{}_RC3_v{}'.format(s, inx + 100)
##        parent_folder = 'syn_xview_bkg_xbw_newbkg_unif_shdw_split_scatter_gauss_rndsolar_promu_size_square_bias{}_RC3_v{}'.format(s, inx + 110)
##        print(parent_folder)
##        if not os.path.exists(ce.toFSPath('images/{}'.format(parent_folder))):
##            os.makedirs(ce.toFSPath('images/{}'.format(parent_folder)))
#    size_pro = 0
#    inx = size_pro_list.index(size_pro)
##    parent_folder = 'syn_xview_bkg_xbw_xbkg_unif_shdw_split_scatter_gauss_rndsolar_promu_size_bias{}_RC3_v{}'.format(size_pro, inx + 40)
##    parent_folder = 'syn_xview_bkg_xbw_xbkg_unif_shdw_split_scatter_gauss_rndsolar_promu_size_square_bias{}_RC3_v{}'.format(size_pro, inx + 100)
#    parent_folder = 'syn_xview_bkg_xbw_newbkg_unif_shdw_split_scatter_gauss_rndsolar_promu_size_square_bias{}_RC3_v{}'.format(size_pro, inx + 110)
