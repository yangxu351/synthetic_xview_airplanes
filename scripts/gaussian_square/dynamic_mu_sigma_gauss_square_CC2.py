...
if __name__ == '__main__':
    ...
    '''
    '''#### color augmentation ####'''
    rgb_rule_file = 'rules/xview_gaussian/xsbw_xcolor_uniform_CC2/yx_xview_plane_cc2_color_gauss.cga' #, 'rules/xview/xsbw_xcolor_uniform_for_one_model_bias_rc1/yx_xview_plane_mixed.cga'
    gt_rule_file = 'rules/xview_gaussian/xsbw_xcolor_uniform_CC2/yx_xview_plane_cc2_color_labeling_gauss.cga' #, 'rules/xview/xsbw_xcolor_uniform_for_one_model_bias_rc1/yx_xview_plane_labeling_mixed.cga'
    '''########### dynsigma color'''
    color_pro_list = [1, 2, 3, 4]
#    for s in color_pro_list:
#        inx = color_pro_list.index(s)
##        parent_folder = 'syn_xview_bkg_shdw_split_scatter_gauss_rndsolar_ssig0.24_color_square_bias{}_CC2_v{}'.format(s, inx + 31)
#        parent_folder = 'syn_xview_bkg_new_bkg_shdw_split_scatter_gauss_rndsolar_ssig0.12_color_square_bias{}_CC2_v{}'.format(s, inx + 46)
#        print(parent_folder)
...
#    parent_folder = 'syn_xview_bkg_shdw_split_scatter_gauss_rndsolar_ssig0.24_color_square_bias{}_CC2_v{}'.format(color_pro, inx + 31)
    parent_folder = 'syn_xview_bkg_new_bkg_shdw_split_scatter_gauss_rndsolar_ssig0.12_color_square_bias{}_CC2_v{}'.format(color_pro, inx + 46)

    '''#### same bwcolr color augmentation ####'''
#    rgb_rule_file = 'rules/xview_gaussian/xsbw_xcolor_uniform_CC2/yx_xview_plane_cc2_same_bwcolor_gauss.cga' #, 'rules/xview/xsbw_xcolor_uniform_for_one_model_bias_rc1/yx_xview_plane_mixed.cga'
#    gt_rule_file = 'rules/xview_gaussian/xsbw_xcolor_uniform_CC2/yx_xview_plane_cc2_same_bwcolor_labeling_gauss.cga' #, 'rules/xview/xsbw_xcolor_uniform_for_one_model_bias_rc1/yx_xview_plane_labeling_mixed.cga'
#    '''########### dynsigma color'''
#    color_pro_list = [1, 2, 3, 4]
##    for s in color_pro_list:
##        inx = color_pro_list.index(s)
###        parent_folder = 'syn_xview_bkg_shdw_split_scatter_gauss_rndsolar_ssig0.24_same_bwcolor_square_bias{}_CC2_v{}'.format(s, inx + 36)
##        print(parent_folder)
##        if not os.path.exists(ce.toFSPath('images/{}'.format(parent_folder))):
##            os.makedirs(ce.toFSPath('images/{}'.format(parent_folder)))
#    color_pro = 4
#    inx = color_pro_list.index(color_pro)
##    parent_folder = 'syn_xview_bkg_shdw_split_scatter_gauss_rndsolar_ssig0.24_same_bwcolor_square_bias{}_CC2_v{}'.format(color_pro, inx + 36)
    

    
    '''#### size augmentation  ####'''
#    rgb_rule_file = 'rules/xview_gaussian/xsbw_xcolor_uniform_CC2/size/yx_xview_plane_cc2_size_gauss.cga' #, 'rules/xview/xsbw_xcolor_uniform_for_one_model_bias_rc1/yx_xview_plane_mixed.cga'
#    gt_rule_file = 'rules/xview_gaussian/xsbw_xcolor_uniform_CC2/size/yx_xview_plane_cc2_size_labeling_gauss.cga' #, 'rules/xview/xsbw_xcolor_uniform_for_one_model_bias_rc1/yx_xview_plane_labeling_mixed.cga'
#    
#    '''########### dynsigma'''
#    size_pro = 0
#    size_pro_list = [0, 0.06, 0.12, 0.18, 0.24]
##    for s in size_pro_list:
##        inx = size_pro_list.index(s)
###        parent_folder = 'syn_xview_bkg_shdw_split_scatter_gauss_rndsolar_promu_size_square_bias{}_CC2_v{}'.format(s, inx + 20)
##        parent_folder = 'syn_xview_bkg_new_bkg_shdw_split_scatter_gauss_rndsolar_promu_size_square_bias{}_CC2_v{}'.format(s, inx + 40)
##        print(parent_folder)
##        if not os.path.exists(ce.toFSPath('images/{}'.format(parent_folder))):
##            os.makedirs(ce.toFSPath('images/{}'.format(parent_folder)))
#    inx = size_pro_list.index(size_pro)
##    parent_folder = 'syn_xview_bkg_shdw_split_scatter_gauss_rndsolar_promu_size_square_bias{}_CC2_v{}'.format(size_pro, inx + 20)
#    parent_folder = 'syn_xview_bkg_new_bkg_shdw_split_scatter_gauss_rndsolar_promu_size_square_bias{}_CC2_v{}'.format(size_pro, inx + 40)
