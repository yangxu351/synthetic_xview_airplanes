...
if __name__ == '__main__':
    ...
    '''
    '''#### color augmentation ####'''
    rgb_rule_file = 'rules/xview_gaussian/xsbw_xwing_color_uniform_for_one_model_rc2/yx_xview_plane_rc2_color_gauss.cga' #, 'rules/xview/xsbw_xcolor_uniform_for_one_model_bias_rc1/yx_xview_plane_mixed.cga'
    gt_rule_file = 'rules/xview_gaussian/xsbw_xwing_color_uniform_for_one_model_rc2/yx_xview_plane_rc2_color_labeling_gauss.cga' #, 'rules/xview/xsbw_xcolor_uniform_for_one_model_bias_rc1/yx_xview_plane_labeling_mixed.cga'
    '''########### dynsigma color'''
    color_pro_list = [10, 20, 30, 40]
#    for s in color_pro_list:
#        inx = color_pro_list.index(s)
##        parent_folder = 'syn_xview_bkg_xbsw_xwing_xbkg_shdw_split_scatter_gauss_rndsolar_ssig0_color_bias{}_RC2_v{}'.format(s, inx + 61)
##        parent_folder = 'syn_xview_bkg_xbsw_xwing_xbkg_shdw_split_scatter_gauss_rndsolar_ssig0_color_square_bias{}_RC2_v{}'.format(s, inx + 91)
#        parent_folder = 'syn_xview_bkg_xbsw_xwing_newbkg_shdw_split_scatter_gauss_rndsolar_ssig0.09_color_square_bias{}_RC2_v{}'.format(s, inx + 116)
#        print(parent_folder)
...
#    parent_folder = 'syn_xview_bkg_xbsw_xwing_xbkg_shdw_split_scatter_gauss_rndsolar_ssig0_color_bias{}_RC2_v{}'.format(color_pro, inx + 61)
#    parent_folder = 'syn_xview_bkg_xbsw_xwing_xbkg_shdw_split_scatter_gauss_rndsolar_ssig0_color_square_bias{}_RC2_v{}'.format(color_pro, inx + 91)
    parent_folder = 'syn_xview_bkg_xbsw_xwing_newbkg_shdw_split_scatter_gauss_rndsolar_ssig0.09_color_square_bias{}_RC2_v{}'.format(color_pro, inx + 116)
    
    '''#### size augmentation  ####'''
#    rgb_rule_file = 'rules/xview_gaussian/xsbw_xwing_color_uniform_for_one_model_rc2/size_aug/yx_xview_plane_rc2_box_muller.cga' #, 'rules/xview/xsbw_xcolor_uniform_for_one_model_bias_rc1/yx_xview_plane_mixed.cga'
#    gt_rule_file = 'rules/xview_gaussian/xsbw_xwing_color_uniform_for_one_model_rc2/size_aug/yx_xview_plane_rc2_labeling_box_muller.cga' #, 'rules/xview/xsbw_xcolor_uniform_for_one_model_bias_rc1/yx_xview_plane_labeling_mixed.cga'
#    
#    '''########### dynsigma'''
#    size_pro = 0
...
##        #parent_folder = 'syn_xview_bkg_xbsw_xwing_xbkg_shdw_split_scatter_gauss_rndsolar_promu_size_bias{}_RC2_v{}'.format(s, inx + 40)
###        parent_folder = 'syn_xview_bkg_xbsw_xwing_xbkg_shdw_split_scatter_gauss_rndsolar_promu_size_square_bias{}_RC2_v{}'.format(s, inx + 100)
##        parent_folder = 'syn_xview_bkg_xbsw_xwing_newbkg_shdw_split_scatter_gauss_rndsolar_promu_size_square_bias{}_RC2_v{}'.format(s, inx + 110)
##        print(parent_folder)
##        if not os.path.exists(ce.toFSPath('images/{}'.format(parent_folder))):
##            os.makedirs(ce.toFSPath('images/{}'.format(parent_folder)))
#    inx = size_pro_list.index(size_pro)
#    #parent_folder = 'syn_xview_bkg_xbsw_xwing_xbkg_shdw_split_scatter_gauss_rndsolar_promu_size_bias{}_RC2_v{}'.format(size_pro, inx + 40)
##    parent_folder = 'syn_xview_bkg_xbsw_xwing_xbkg_shdw_split_scatter_gauss_rndsolar_promu_size_square_bias{}_RC2_v{}'.format(size_pro, inx + 100)
#    parent_folder = 'syn_xview_bkg_xbsw_xwing_newbkg_shdw_split_scatter_gauss_rndsolar_promu_size_square_bias{}_RC2_v{}'.format(size_pro, inx + 110)
...
#            ce.refreshFolder(ce.toFSPath('images/{}'.format(folder_name)))
...
#        tag='{}_airplanes_xview_background_sd{}'.format(dt, sd) 
#        mode = 'GT'
#        folder_name='{}/{}_all_annos_step{}'.format(parent_folder, dt, STEP, sd, dt, STEP)  
##        print('folder_name', folder_name)
#        if not os.path.exists(ce.toFSPath('images/{}'.format(folder_name))):
#            os.makedirs((ce.toFSPath('images/{}'.format(folder_name))))
#        solar_ele_angle = random.randint(40, 70)
